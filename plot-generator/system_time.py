...
path = "../abe-scheme/results/system-time-get/variable_policy_time_OR.csv"
path2 = "../abe-scheme/results/system-time-get/variable_policy_time_AND.csv"
path3 = "../abe-scheme/results/system-time-get/variable_policy_time_BOTH.csv"
markers = ["o","^","s"];
...
plt.plot(data['attributes'], data['large'], label="large (OR)" , marker=markers[2], linestyle="-", color=colors1[2])
...
plt.plot(data2['attributes'], data2['large'], label="large (AND)" , marker=markers[2], linestyle="-", color=colors2[2])
...
plt.plot(data3['attributes'], data3['large'], label="large (BOTH)" , marker=markers[2], linestyle="-", color=colors3[2])
