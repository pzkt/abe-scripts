...
#plt.semilogy(data[0].index, reference_line, 'r--', label=f'Exponential growth (factor 2)')
...
for i in range(len(data)):
    ...
    plt.semilogy(data[i].index, adjusted_values, label=files[i] , marker=markers[i], linestyle="-", color=lib_colors[i])
